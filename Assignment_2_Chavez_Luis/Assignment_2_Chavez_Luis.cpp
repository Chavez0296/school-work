//The following program declares and manipulates some Fractoin objects using overloaded operators. It then declares and manipulates
//a FracList object which holds an array of Fraction objects, using overloaded FracList operators. In the end, it sorts and conducts
//binary search on the list, displaying the lisit each time.

#include <iostream> // this is for cin, cout, endl, etc.
#include <conio.h> //used for _getch() which pauses the program unti a key is pressed
#include "Fraction.h"
using namespace std; // this says it uses the namespace called std

void swap(FracList& l1, FracList& l2, int&, int&);
